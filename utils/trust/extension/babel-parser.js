var BabelParser = (() => {
    ...
    // http-url:https://unpkg.com/@babel/parser@7.28.5/lib/index.js
    var require_lib = __commonJS({
        "http-url:https://unpkg.com/@babel/parser@7.28.5/lib/index.js"(exports) {
            "use strict";
...
- Did you mean \`import { "${importName}" as foo }\`?`,
    ...
    // /input.ts
    var input_exports = {};
    __reExport(input_exports, __toESM(require_lib()));
