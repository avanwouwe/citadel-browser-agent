...
* analyze all use of passwords (only forms with "password" fields, but not Basic Auth)
...
* manage the duration of "session" cookies (if Citadel would set their expiration date that would make the browser persist the cookies)
