...
The extension is available on the web stores of Chrome, and Firefox. This means it is updated automatically, and the installation consists of installing the plugin.
