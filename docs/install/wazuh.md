...
# Wazuh integration
Follow the following steps to ship the system log events to your Wazuh instance.

## change ossec.conf
### macOS
If you haven't already done so, install the [Citadel agent](/install/macos) that Citadel needs to communicate the events outside browser sandbox.
